...
../../wav_aligned # wav files and phonemically-aligned TextGrids (these could in separate directories - in this document we will only deal with the wav files)
data/sf3/...
```
...
process_ag501(
  filename = "sf2_0005.txt",
  sensor_array = c("TT", "TB", "TD", "LT", "UT", "UL", "LL", "U1", "B1", "B2", "B3", "LH", "RH", "NO", "PA", "U2"),
  exclude_list = c("phi", "theta", "rms", "extra", "U1", "U2", "B1", "B2", "B3", "LH", "RH", "NO", "PA", "UT"),
  sampling_rate = 250,
  filter_type = "low",
  filter_order = 5,
  filter_cutoffs = 20
